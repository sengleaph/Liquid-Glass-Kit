...
// Umbrella module: ships no source of its own — re-exports the three real library modules
// via api() so a consumer who depends on just `liquidglass` gets core + theme + components.
dependencies {
